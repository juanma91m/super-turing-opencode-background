...
- se agrega soporte explícito para OpenCode `1.14.46`, `1.14.48` y `1.14.49` con patch versionado dedicado
...
- en `1.14.46`, `1.14.48` y `1.14.49`, los atajos async siguen plugin-side y el sidebar visible mantiene el apoyo en patch host por estabilidad
