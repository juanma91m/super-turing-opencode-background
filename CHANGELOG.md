...
- se agrega soporte explícito para OpenCode `1.14.46` con patch versionado dedicado
...
- en `1.14.46`, los atajos async siguen plugin-side y el sidebar visible mantiene el apoyo en patch host por estabilidad
