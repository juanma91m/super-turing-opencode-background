...
- se agrega soporte explícito para OpenCode `1.14.41` y `1.14.42` con patch versionado dedicado
...
- en `1.14.42`, los atajos async siguen plugin-side pero el sidebar visible vuelve a apoyarse en patch host por estabilidad
