...
- OpenCode **1.14.39**, **1.14.41**, **1.14.42**, **1.14.46**, **1.14.48** o **1.14.49**
...
- `node`
- `git`
- un checkout fuente compatible de OpenCode `1.14.39`, `1.14.41`, `1.14.42`, `1.14.46`, `1.14.48` o `1.14.49`
...
Si reconstruís el runtime desde otra build, el sufijo timestamp puede variar. Lo importante es que ya no esté ejecutando la versión local original `1.14.39`, `1.14.41`, `1.14.42`, `1.14.46`, `1.14.48` o `1.14.49` del install previo.

### 4. Actualizar una instalación ya adoptada a otra versión soportada

Si ya estabas en `managed-local-install` sobre otra versión soportada (por ejemplo `1.14.39`, `1.14.41`, `1.14.42`, `1.14.46` o `1.14.48`) y querés pasar a `1.14.49`:
