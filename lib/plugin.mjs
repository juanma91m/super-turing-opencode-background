...
export async function inspectManagedFile(sourcePath, installedPath) {
...
export async function inspectPlugin(sourcePath, installedPath) {
  return inspectManagedFile(sourcePath, installedPath);
}
...
export async function installManagedFile(
  ...
  const status = await inspectManagedFile(sourcePath, installedPath);
...
export async function installPlugin(
  ...
  return installManagedFile(sourcePath, installedPath, options);
}
...
export async function removePlugin(
  ...
  return removeManagedFile(sourcePath, installedPath, state, options);
}
