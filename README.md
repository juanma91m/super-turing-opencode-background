...
- un **patch versionado del host/core** para OpenCode `1.14.39`, `1.14.41`, `1.14.42`, `1.14.46`, `1.14.48` y `1.14.49`,
...
- `patched-source-checkout` sobre OpenCode **1.14.39**, **1.14.41**, **1.14.42**, **1.14.46**, **1.14.48** y **1.14.49**
...
> Add-on alpha para OpenCode 1.14.39 / 1.14.41 / 1.14.42 / 1.14.46 / 1.14.48 / 1.14.49,
